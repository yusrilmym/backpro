  ...
  <div class="col-lg-8 mb-4 order-0">
    <div class="card">
      <div class="d-flex align-items-end row">
        <div class="col-sm-7">
          <div class="card-body">
            <h5 class="card-title text-primary">Website Perhitungan Propagation! 🎉</h5>
            <p class="mb-4">Perhitungan dan normalisasi <span class="fw-bold">PROPAGATION </span>Buka untuk masing - masing menu.</p>
